...
function addToCart(){ 
    $('.add_to_cart').click(function(){
        ...
        var weight = $("#weight"+productId).val();
        if(qty){
        ...
        var loader=$('#cartLoader'+productId);
        $.ajax({
            type: "POST",
            dataType:"json",
            ...
            data:{
                product_id: productId, qty:qtys, weight:weight,       
            },
            beforeSend: function(){
                $('#cartLoader'+productId).css('display','inline-block');
            ...
            error:function(xhr,textStatus){
                ...
                $('.listingloader').hide();
                $('#cartLoader'+productId).prop('disabled', false);
                $('#add_to_cart'+productId).prop('disabled', false);
            },
            success: function(data){
                ...
                $('#cartLoader'+productId).css('display','none');
                $('#add_to_cart'+productId).prop('disabled', false);
                $('.listingloaderHeader').hide();
                //cartList();
            }
        }); 
    }); 
