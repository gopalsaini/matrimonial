         ...
         <div class="col-xxl-6 col-xl-6 col-md-8 mx-auto">
            <div class="card">
               <div class="card-body">
                  ...
                  <form class="form-default" data-loader="load_register" role="form" action="{{url('/registerform')}}" method="POST" id="test">
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="form-group mb-3">
                              <label class="form-label" for="on_behalf">On Behalf</label>
                              <select class="form-control  " name="behalf" required>
                     ...
                     <div class="form-group phone-form-group mb-1">
                        <input type="tel" id="mobile" class="form-control" value="" placeholder="" name="mobile"  onkeypress="return /[0-9 ]/i.test(event.key)" onkeypress="return /[0-9 ]/i.test(event.key)" pattern="^\d{10}$"
                     ...
                     <div class="mb-5">
						...
						Create Account<span id="" class="load_register load-btn"
...
<div class="py-4 py-lg-5" style="display:none;" id="otpsubmitform">
   <div class="container">
      <div class="row">
         <div class="col-xxl-6 col-xl-6 col-md-8 mx-auto">
            <div class="card">
					 ...
					 <div class="form-block"  id="">
						 <section class="user-form">
							...
							<form id="test" data-loader="load_register" action="{{url('/submitotp')}}"
							   ...
							   <div class="otp-inputs" id="login-input" style="text-align: center;margin-top: 24px;">
