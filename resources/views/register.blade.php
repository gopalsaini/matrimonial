			...
			<div class="col-xxl-6 col-xl-6 col-md-8 mx-auto">
				<div class="card">
					<div class="card-body">
						...
						<form class="form-default" role="form" action="https://demo.activeitzone.com/matrimonial/register" method="POST">
							<input type="hidden" name="_token" value="IamRzJLqRe9LjkNEV08qaRykc3BhpzPVLkbe0ED7">							<div class="row">
								<div class="col-lg-12">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="text" class="form-control aiz-date-range " name="date_of_birth" id="date_of_birth" placeholder="Date Of Birth" data-single="true" data-show-dropdown="true"  required>
																			</div>
								</div>
							</div>
															<label class="form-label" for="email">Email / Phone</label>
								<div class="form-group phone-form-group mb-1">
				            <input type="number" id="phone-code" class="form-control" value="" placeholder="" name="phone" autocomplete="off">
				        </div>
