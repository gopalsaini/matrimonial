...
<head>
    ...
    <meta name="csrf-token" content="nSJYhOmvaoAplNpuPjxWuCa3SbqjAzxKh8fbrLN6">
...
<body class="text-left">
            ...
            <div class="row align-items-center">
                ...
                <a href="https://demo.activeitzone.com/matrimonial/notification-view/159" class="media text-inherit">
                    ...
                    <div class="media-body">
                        ...
                        <li class="list-inline-item">
                            <a href="https://demo.activeitzone.com/matrimonial/logout"
        ...
        <div class="aiz-navbar position-relative">
            ...
            <div class="container">
                <ul class="list-inline d-flex align-items-center mb-0">
                    <li class="list-inline-item">
                        <a href="https://demo.activeitzone.com/matrimonial/dashboard"
                    ...
                    <li class="list-inline-item">
                        <a href="https://demo.activeitzone.com/matrimonial/profile-settings"
                            class="text-reset d-inline-block px-4 py-3 fw-600 ">
                    ...
                    <li class="list-inline-item">
                        <a href="https://demo.activeitzone.com/matrimonial/my-interests"
                            class="text-reset d-inline-block px-4 py-3 fw-600 ">
                    ...
                    <li class="list-inline-item">
                        <a href="https://demo.activeitzone.com/matrimonial/my-shortlists"
                            class="text-reset d-inline-block px-4 py-3 fw-600 text-primary-grad opacity-100">
                    ...
                    <li class="list-inline-item">
                        <a href="https://demo.activeitzone.com/matrimonial/ignored-list"
                            class="text-reset d-inline-block px-4 py-3 fw-600 ">
    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        <div class="px-4 text-center mb-4">
            ...
            <h4 class="h5 fw-600">Ryan Ryan</h4>
            ...
            <a href="javascript:void(0);" class="btn btn-block btn-primary" href="https://demo.activeitzone.com/matrimonial/logout"
               onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                ...
                <form id="logout-form" action="https://demo.activeitzone.com/matrimonial/logout" method="POST" style="display: none;">
                    <input type="hidden" name="_token" value="nSJYhOmvaoAplNpuPjxWuCa3SbqjAzxKh8fbrLN6">                </form>
            </a>
        </div>
    </div>
</div>
        ...
        <div class="card-body">
            <table class="table aiz-table mb-0">
              ...
              <tbody>
                                        <tr id="shortlisted_member_29">
                          <td>1</td>
                          <td>
                            <img class="img-md" src="https://demo.activeitzone.com/matrimonial/public/uploads/all/frIh1shOagKEHjg33H1CzyljjmGeg18jIjikmqxZ.png" height="45px"  alt="Photo">
                          </td>
                          <td>Olivia Emma</td>
                          <td>17</td>
                                                    <td>
                                    ...
                                    <i class="las la-heart"></i>
                                                            ...
                                                            <a onclick="remove_shortlist(29)" class="btn btn-soft-danger btn-icon btn-circle btn-sm" title="Remove">
                                  <i class="las la-trash-alt"></i>
                              </a>
                          </td>
                      </tr>
                                        <tr id="shortlisted_member_42">
                          <td>2</td>
                          <td>
                            <img class="img-md" src="https://demo.activeitzone.com/matrimonial/public/uploads/all/AKgrssE0aIV4yzwTzRQsBaNp93KS2PPp5wqMsld9.png" height="45px"  alt="Photo">
                          </td>
                          <td>Donnam J. Perryman</td>
                          <td>28</td>
                                                    <td>
                                                            Islam
                                                      </td>
                                    ...
                                    <i class="las la-heart"></i>
                                                            ...
                                                            <a onclick="remove_shortlist(42)" class="btn btn-soft-danger btn-icon btn-circle btn-sm" title="Remove">
                                  <i class="las la-trash-alt"></i>
                              </a>
                          </td>
                      </tr>
                                        <tr id="shortlisted_member_28">
                          <td>3</td>
                          <td>
                            <img class="img-md" src="https://demo.activeitzone.com/matrimonial/public/uploads/all/9uC6PPkpVpfOu5FuhF2enDj3Com30pgwnLjWZlR1.png" height="45px"  alt="Photo">
                          </td>
                          <td>Liam Noah</td>
                          <td>30</td>
                                                    <td>
                                    ...
                                    <i class="las la-heart"></i>
                                                            ...
                                                            <a onclick="remove_shortlist(28)" class="btn btn-soft-danger btn-icon btn-circle btn-sm" title="Remove">
                                  <i class="las la-trash-alt"></i>
                              </a>
                          </td>
                      </tr>
                                        <tr id="shortlisted_member_38">
                          <td>4</td>
                          <td>
                            <img class="img-md" src="https://demo.activeitzone.com/matrimonial/public/uploads/all/VnXkjr8WzmYtJD3F2K0Jtbw1QD2CHkb249rpY2W8.png" height="45px"  alt="Photo">
                          </td>
                          <td>Kathy T. Litton</td>
                          <td>28</td>
                                                    <td>
                                                      </td>
                                                                              <td>
                                    ...
                                    <i class="las la-heart"></i>
                                                            ...
                                                            <a onclick="remove_shortlist(38)" class="btn btn-soft-danger btn-icon btn-circle btn-sm" title="Remove">
                                  <i class="las la-trash-alt"></i>
                              </a>
                          </td>
                      </tr>
                                        <tr id="shortlisted_member_30">
                          <td>5</td>
                          <td>
                          ...
                          <td>28</td>
                                    ...
                                    <i class="las la-heart"></i>
                                                            ...
                                                            <a onclick="remove_shortlist(30)" class="btn btn-soft-danger btn-icon btn-circle btn-sm" title="Remove">
                                  <i class="las la-trash-alt"></i>
                              </a>
                          </td>
                      </tr>
...
EN-IN" lang="EN-IN">We aspire to provide the best service to our clients. Our team at CK matrimony is committed to your online safety and satisfaction.&nbsp;<o:p></o:p></span></p>
            ...
            <div class="row opacity-60 no-gutters">
                    ...
                    <div><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d9bab299bab2b4b8adabb0b4b6b7a0f7bab6b4">[email&#160;protected]</a></div>
                </div>
                                                <div class="col-xl col-md-6 mb-4">
                    <div class="mb-3 opacity-60">
            ...
            <a href="https://demo.activeitzone.com/matrimonial/member/notifications" class="text-reset d-block flex-grow-1 text-center py-2">
                <span class="d-inline-block position-relative px-2">
                    <i class="las la-bell fs-18 opacity-60 "></i>
                                                                                                <span class="badge badge-sm badge-circle badge-primary position-absolute absolute-top-right">3</span>
                                                            </span>
  ...
  <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    <form class="form-horizontal member-block" action="https://demo.activeitzone.com/matrimonial/member/account-activation" method="POST">
                        <input type="hidden" name="_token" value="nSJYhOmvaoAplNpuPjxWuCa3SbqjAzxKh8fbrLN6">                        <input type="hidden" name="deacticvation_status" id="deacticvation_status" value="">
    ...
    function remove_shortlist(id) {
      $.post('https://demo.activeitzone.com/matrimonial/member/remove-from-shortlist',
        {
          _token: 'nSJYhOmvaoAplNpuPjxWuCa3SbqjAzxKh8fbrLN6',
          id: id
        },
        function (data) {
          if (data == 1) {
            $("#shortlisted_member_"+id).hide();
            AIZ.plugins.notify('success', 'You Have Removed this Member From Shortlist');
          }
          else {
    ...
    function express_interest(id)
    {
        if( package_validity == 0 || remaining_interest < 1){
          ...
          $("#confirm_modal_content").html("<p class='fs-14'>Remaining Express Interests: "+remaining_interest+" times</p><small class='text-danger'>**N.B. Expressing An Interest Will Cost 1 From Your Remaining Interests**</small>");
      ...
      $.post('https://demo.activeitzone.com/matrimonial/express-interest',
        ...
        function (data) {
          if (data == 1) {
            ...
            $("#interest_a_id_"+id).attr("title","Interest Expressed");
    ...
    <script type="text/javascript">
            ...
            if(status == 0)
            {
                ...
                $('#confirmation_note').html('Do You Realy Want To Deactive Your Account');
            }
            else {
